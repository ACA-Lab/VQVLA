...
class PolicyServer:
    ...
    def __init__(
        ...
        self.register_endpoint("print_and_reset", self.policy.print_and_reset)
...
class PolicyClient(BasePolicy):
    ...
    def print_and_reset(
        self, xlsx_file_name: str
    ) -> None:
        _ = self.call_endpoint("print_and_reset", {"xlsx_file_name": xlsx_file_name})
