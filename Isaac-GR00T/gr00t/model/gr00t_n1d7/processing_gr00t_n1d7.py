...
def build_processor(model_name: str, transformers_loading_kwargs: dict) -> Qwen3VLProcessor:
    ...
    local_model_path = "/home/haozhe.jiang/Isaac-GR00T/checkpoints/Cosmos-Reason2-2B"
    print("build_processor, this code is at: /home/haozhe.jiang/Isaac-GR00T/gr00t/model/gr00t_n1d7/processing_gr00t_n1d7.py")
    load_source = local_model_path if local_model_path else model_name
    return Qwen3VLProcessor.from_pretrained(load_source, local_files_only=True, **transformers_loading_kwargs)
